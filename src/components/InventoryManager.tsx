...
export default function InventoryManager() {
  ...
  const generateEmailPreview = async (po: PurchaseOrder) => {
    ...
    try {
      ...
      const prompt = `You are a professional procurement officer at WebPOS, a modern retail point-of-sale system. 
      ...
      setGeneratedEmail({
        subject: data.subject || `Purchase Order ${po.id} - WebPOS`,
      ...
      setGeneratedEmail({
        subject: `Purchase Order ${po.id} - WebPOS`,
